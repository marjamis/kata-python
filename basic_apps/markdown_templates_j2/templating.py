...
class TemplateEngine():
  ...
  def __init__(self):
    ...
    print(f'Using the template directory: {self.templates_directory}.')
  ...
  def generate_output_from_template(self, template, context):
    try:
      ...
      raise TemplateNotFound(message="The template {message} wasn't found in the templates directory location of {dir}.".format(
        message=e.message,
        dir=self.templates_directory
      ))
